...
abstract public class TIntIntExtHash extends TPrimitiveHash {
	 ...
	 */
	public TIntIntExtHash(TIntHashingStrategy hasher, int initialCapacity) {
	 ...
	 *            place.
	 */
	public TIntIntExtHash(TIntHashingStrategy hasher, int initialCapacity, float loadFactor) {
