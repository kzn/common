 ...
 */
public class TIntIntExtHashMap extends TIntIntExtHash implements TIntIntMap, Externalizable {
     ...
     */
    public TIntIntExtHashMap(TIntHashingStrategy hasher, int initialCapacity ) {
     ...
     */
    public TIntIntExtHashMap(TIntHashingStrategy hasher, int initialCapacity, float loadFactor ) {
     ...
     */
    public TIntIntExtHashMap(TIntHashingStrategy hasher, int[] keys, int[] values ) {
    ...
    public TIntIntIterator iterator() {
        return new TIntIntExtHashIterator(this);
    }
    ...
    protected class TKeyView implements TIntSet {
        ...
        public TIntIterator iterator() {
            return new TIntIntKeyHashIterator( TIntIntExtHashMap.this );
        }
        ...
        public boolean contains( int entry ) {
            return TIntIntExtHashMap.this.contains( entry );
        }


        /** {@inheritDoc} */
        public int[] toArray() {
            return TIntIntExtHashMap.this.keys();
        }


        /** {@inheritDoc} */
        public int[] toArray( int[] dest ) {
            return TIntIntExtHashMap.this.keys( dest );
        }
        ...
        public boolean remove( int entry ) {
            return no_entry_value != TIntIntExtHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Integer ) {
                    ...
                    if ( ! TIntIntExtHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TIntCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TIntIntExtHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( int[] array ) {
            for ( int element : array ) {
                if ( ! TIntIntExtHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        /** {@inheritDoc} */
        public void clear() {
            TIntIntExtHashMap.this.clear();
        }


        /** {@inheritDoc} */
        public boolean forEach( TIntProcedure procedure ) {
            return TIntIntExtHashMap.this.forEachKey( procedure );
        }
    ...
    protected class TValueView implements TIntCollection {
        ...
        /** {@inheritDoc} */
        public TIntIterator iterator() {
            return new TIntIntValueHashIterator( TIntIntExtHashMap.this );
        }
        ...
        /** {@inheritDoc} */
        public boolean contains( int entry ) {
            return TIntIntExtHashMap.this.containsValue( entry );
        }


        /** {@inheritDoc} */
        public int[] toArray() {
            return TIntIntExtHashMap.this.values();
        }


        /** {@inheritDoc} */
        public int[] toArray( int[] dest ) {
            return TIntIntExtHashMap.this.values( dest );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Integer ) {
                    int ele = ( ( Integer ) element ).intValue();
                    if ( ! TIntIntExtHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TIntCollection collection ) {
            TIntIterator iter = collection.iterator();
            while ( iter.hasNext() ) {
                if ( ! TIntIntExtHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( int[] array ) {
            for ( int element : array ) {
                if ( ! TIntIntExtHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        /** {@inheritDoc} */
        public boolean forEach( TIntProcedure procedure ) {
            return TIntIntExtHashMap.this.forEachValue( procedure );
        }
    ...
    class TIntIntKeyHashIterator extends THashPrimitiveIterator implements TIntIterator {
        ...
        public void remove() {
            ...
            try {
                ...
                TIntIntExtHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TIntIntExtHashIterator extends THashPrimitiveIterator implements TIntIntIterator {
         ...
         */
        TIntIntExtHashIterator( TIntIntExtHashMap map ) {
            super( map );
        }
