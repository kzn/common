...
/**
 * An open addressed hashing implementation for int primitives with external hashing.
 *
 ...
 */
abstract public class TIntExtHash extends TPrimitiveHash {
     ...
     */
    public TIntExtHash(TIntHashingStrategy hasher) {
        super();
        this.hasher = hasher;
     ...
     */
    public TIntExtHash(TIntHashingStrategy hasher, int initialCapacity ) {    	
     ...
     */
    public TIntExtHash(TIntHashingStrategy hasher, int initialCapacity, float loadFactor ) {
     ...
     */
    public TIntExtHash(TIntHashingStrategy hasher, int initialCapacity, float loadFactor, int no_entry_value ) {
        super(initialCapacity, loadFactor);
        this.hasher = hasher;
    ...
    protected int index( int val ) {
        ...
        if (state == FULL && hasher.equals(set[index],val))
            return index;
