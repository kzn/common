 ...
 */
public class TIntLongExtHashMap extends TIntLongExtHash implements TIntLongMap, Externalizable {
     ...
     */
    public TIntLongExtHashMap(TIntHashingStrategy hasher, int initialCapacity ) {
        super(hasher, initialCapacity );
    }
     ...
     */
    public TIntLongExtHashMap(TIntHashingStrategy hasher, int initialCapacity, float loadFactor ) {
    ...
    public TIntLongExtHashMap(TIntHashingStrategy hasher, int initialCapacity, float loadFactor,
        ...
        super(hasher, initialCapacity, loadFactor, noEntryKey, noEntryValue );
    }
     ...
     */
    public TIntLongExtHashMap(TIntHashingStrategy hasher, int[] keys, long[] values ) {
        super(hasher, Math.max( keys.length, values.length ) );
     ...
     */
    public TIntLongExtHashMap(TIntHashingStrategy hasher, TIntLongMap map ) {
        super(hasher, map.size() );
        if ( map instanceof TIntLongExtHashMap ) {
            TIntLongExtHashMap hashmap = ( TIntLongExtHashMap ) map;
    ...
    protected class TKeyView implements TIntSet {
        ...
        public TIntIterator iterator() {
            return new TIntLongKeyHashIterator( TIntLongExtHashMap.this );
        }
        ...
        public boolean contains( int entry ) {
            return TIntLongExtHashMap.this.contains( entry );
        }


        /** {@inheritDoc} */
        public int[] toArray() {
            return TIntLongExtHashMap.this.keys();
        }


        /** {@inheritDoc} */
        public int[] toArray( int[] dest ) {
            return TIntLongExtHashMap.this.keys( dest );
        }
        ...
        public boolean remove( int entry ) {
            return no_entry_value != TIntLongExtHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Integer ) {
                    ...
                    if ( ! TIntLongExtHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TIntCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TIntLongExtHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( int[] array ) {
            for ( int element : array ) {
                if ( ! TIntLongExtHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        /** {@inheritDoc} */
        public void clear() {
            TIntLongExtHashMap.this.clear();
        }


        /** {@inheritDoc} */
        public boolean forEach( TIntProcedure procedure ) {
            return TIntLongExtHashMap.this.forEachKey( procedure );
        }
    ...
    protected class TValueView implements TLongCollection {
        ...
        public TLongIterator iterator() {
            return new TIntLongValueHashIterator( TIntLongExtHashMap.this );
        }
        ...
        public boolean contains( long entry ) {
            return TIntLongExtHashMap.this.containsValue( entry );
        }


        /** {@inheritDoc} */
        public long[] toArray() {
            return TIntLongExtHashMap.this.values();
        }


        /** {@inheritDoc} */
        public long[] toArray( long[] dest ) {
            return TIntLongExtHashMap.this.values( dest );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Long ) {
                    ...
                    if ( ! TIntLongExtHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TLongCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TIntLongExtHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( long[] array ) {
            for ( long element : array ) {
                if ( ! TIntLongExtHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean forEach( TLongProcedure procedure ) {
            return TIntLongExtHashMap.this.forEachValue( procedure );
        }
    ...
    class TIntLongKeyHashIterator extends THashPrimitiveIterator implements TIntIterator {
        ...
        public void remove() {
            ...
            try {
                ...
                TIntLongExtHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TIntLongHashIterator extends THashPrimitiveIterator implements TIntLongIterator {
         ...
         */
        TIntLongHashIterator( TIntLongExtHashMap map ) {
            super( map );
        }
