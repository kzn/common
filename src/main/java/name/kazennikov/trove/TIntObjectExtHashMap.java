 ...
 * @author Jeff Randall
 */
public class TIntObjectExtHashMap<V> extends TIntExtHash implements
    ...
    protected TIntHashingStrategy hasher;
     ...
     */
    public TIntObjectExtHashMap(TIntHashingStrategy hasher) {
        super(hasher);
        this.hasher = hasher;
    }
     ...
     */
    public TIntObjectExtHashMap(TIntHashingStrategy hasher, int initialCapacity ) {
     ...
     */
    public TIntObjectExtHashMap(TIntHashingStrategy hasher, int initialCapacity, float loadFactor ) {
     ...
     */
    public TIntObjectExtHashMap(TIntHashingStrategy hasher, int initialCapacity, float loadFactor, int noEntryKey ) {
        super(hasher, initialCapacity, loadFactor );
        this.hasher = hasher;
     ...
     */
    public TIntObjectExtHashMap(TIntHashingStrategy hasher, TIntObjectMap<? extends V> map ) {
        this(hasher, map.size(), 0.5f, map.getNoEntryKey() );
        putAll( map );
    }
   ...
   public int[] keys( int[] dest ) {
    ...
    public int hashCode() {
        ...
        for ( int i = values.length; i-- > 0; ) {
            if ( states[i] == FULL ) {
                hashcode += hasher.computeHashCode( _set[i] ) ^
    ...
    class KeyView implements TIntSet {
        ...
        public boolean contains( int entry ) {
            return TIntObjectExtHashMap.this.containsKey( entry );
        }

        /** {@inheritDoc} */
        public TIntIterator iterator() {
            return new TIntHashIterator( TIntObjectExtHashMap.this );
        }
        ...
        public boolean remove( int entry ) {
            return null != TIntObjectExtHashMap.this.remove( entry );
        }

        /** {@inheritDoc} */
        public boolean containsAll( Collection<?> collection ) {
           for ( Object element : collection ) {
                if ( ! TIntObjectExtHashMap.this.containsKey(
        ...
        public boolean containsAll( TIntCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TIntObjectExtHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( int[] array ) {
            for ( int element : array  ) {
                if ( ! TIntObjectExtHashMap.this.containsKey( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        /** {@inheritDoc} */
        public void clear() {
            TIntObjectExtHashMap.this.clear();
        }

        /** {@inheritDoc} */
        public boolean forEach( TIntProcedure procedure ) {
            return TIntObjectExtHashMap.this.forEachKey( procedure );
        }
       ...
       class TIntHashIterator extends THashPrimitiveIterator implements TIntIterator {
            ...
            private final TIntExtHash _hash;

            /** {@inheritDoc} */
            public TIntHashIterator( TIntExtHash hash ) {
                super( hash );
                this._hash = hash;
            }
    ...
    protected class ValueView extends MapBackedView<V> {
        ...
        public Iterator<V> iterator() {
            return new TIntObjectValueHashIterator( TIntObjectExtHashMap.this ) {
        ...
        class TIntObjectValueHashIterator extends THashPrimitiveIterator
            ...
            protected final TIntObjectExtHashMap _map;

            public TIntObjectValueHashIterator( TIntObjectExtHashMap map ) {
                super( map );
                _map = map;
            }
    ...
    private abstract class MapBackedView<E> extends AbstractSet<E>
        ...
        public int size() {
            return TIntObjectExtHashMap.this.size();
        }
        ...
        public boolean isEmpty() {
            return TIntObjectExtHashMap.this.isEmpty();
        }
    ...
    class TIntObjectHashIterator<V> extends THashPrimitiveIterator
        ...
        private final TIntObjectExtHashMap<V> _map;
         ...
         */
        public TIntObjectHashIterator( TIntObjectExtHashMap<V> map ) {
            super( map );
            this._map = map;
        }
